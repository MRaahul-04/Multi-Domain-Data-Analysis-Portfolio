...
![Reports](https://img.shields.io/badge/Reports-PDF-lightgrey)
![OS](https://img.shields.io/badge/OS-Windows%20%7C%20macOS%20%7C%20Linux-lightgrey)
[![Release](https://img.shields.io/badge/Release-v1.0.0-success)](https://github.com/<your-username>/Multi-Domain-Data-Analysis-Portfolio/releases/tag/v1.0.0)
...
|-------------------------------------------------------|---------------------------------------------------------|----------------------------------------------------------|
| ![](visualizations/supermarket/sales_trend_daily.png) | ![](visualizations/supermarket/sales_trend_monthly.png) | ![](visualizations/supermarket/payment_method_share.png) |
...
|--------------------------------------------------------------------|-----------------------------------------------------------------|-----------------------------------------------------------------|
| ![](visualizations/student_performance/pass_fail_distribution.png) | ![](visualizations/student_performance/attendance_vs_score.png) | ![](visualizations/student_performance/correlation_heatmap.png) |
...
|---------------------------------------------------|-------------------------------------------------------------|-----------------------------------------------------|
| ![](visualizations/weather/temperature_trend.png) | ![](visualizations/weather/monthly_average_temperature.png) | ![](visualizations/weather/correlation_heatmap.png) |
...
|-----------------------------------------------------------|--------------------------------------------------------|-----------------------------------------------------------------|
| ![](visualizations/healthcare/mortality_distribution.png) | ![](visualizations/healthcare/age_group_mortality.png) | ![](visualizations/healthcare/clinical_correlation_heatmap.png) |
...
|--------------------------------------------------------------|-------------------------------------------------------|---------------------------------------------------------------|
| ![](visualizations/finance/preferred_investment_avenues.png) | ![](visualizations/finance/risk_factor_vs_avenue.png) | ![](visualizations/finance/clustered_correlation_heatmap.png) |
